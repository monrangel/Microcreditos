					...
					<div class="col-lg-12">
                   		...
                   		<div class="panel-body">
                            ...
                            <ul class="nav nav-pills" style="clear:both;">
                                <li class="active"><a href="#home-pills" data-toggle="tab">Semana 1</a>
                                </li>
                                <li><a href="#profile-pills" data-toggle="tab">Semana 2</a>
                                </li>
                                <li><a href="#messages-pills" data-toggle="tab">Semana 3</a>
											...
											<div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
											   <div class="row">
												...
												<thead>
													...
													<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180px;">Puesto</th>
												...
												<tr class="gradeA odd" role="row">
														...
														<td>Activo</td>
														<td>
															<button type="button" class="btn btn-primary btn-xs">Movimientos</button>
